        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li><Link to="/domains" className="hover:text-blue-600 transition-colors">Domains</Link></li>
              <li><Link to="/internship" className="hover:text-blue-600 transition-colors">Internship</Link></li>
              <li><Link to="/contact" className="hover:text-blue-600 transition-colors">Contact</Link></li>
            </ul>
          </div>

          <div>
            <h3 className="text-slate-900 font-semibold mb-6">Domains</h3>
            <ul className="space-y-4 text-sm">
              <li><Link to="/domains" className="hover:text-blue-600 transition-colors">Web Development</Link></li>
              <li><Link to="/domains" className="hover:text-blue-600 transition-colors">AI & Machine Learning</Link></li>
              <li><Link to="/domains" className="hover:text-blue-600 transition-colors">Data Science</Link></li>
              <li><Link to="/domains" className="hover:text-blue-600 transition-colors">Cyber Security</Link></li>
              <li><Link to="/domains" className="hover:text-blue-600 transition-colors">R & D</Link></li>
            </ul>
          </div>
