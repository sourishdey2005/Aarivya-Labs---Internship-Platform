  ...
  return (
    <nav
      className={cn(
        ...
        scrolled ? 'bg-white/80 backdrop-blur-md shadow-lg border-b border-slate-100 py-3' : 'bg-transparent py-5'
      )}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link
              to="/internship"
              className="bg-blue-600 text-white px-5 py-2 rounded-full text-sm font-medium hover:bg-blue-700 transition-colors flex items-center gap-1 shadow-lg shadow-blue-100"
            >
